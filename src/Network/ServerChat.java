...
/**
 *
 * Der "Admin"Chat, wird er aufgerufen, öffnet sich das Server Window mit. Der Admin muss dann als erstes den Server Starten und bietet
 * so die Basis für die entstehende Chat Verbindung.
 * Betätigt der Admin den Connect Buttn, öffnet sich die Admin GUI der NEtzwerk Lobby, her können die Karten, und Schwierigkeit
 * des Death Matches ausgewählt werden. 
