...
public class ClientMPG2 extends JFrame {
	...
	public static void main(String[] args){
			 ...
			 *  Server starten...
			 */
			ServerIP = JOptionPane.showInputDialog( "Bitte gib die IP-Adresse des Servers ein." );
			try {
				clientInfo.setText(">>>\tSuche nach Server...\n");
				
				clientInfo.append(">>>\tVerbindung wird hergestellt...\n");
				ClientStarten(null);
			} catch (Exception e) {
